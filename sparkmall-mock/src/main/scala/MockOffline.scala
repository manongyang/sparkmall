...
import com.atguigu.sparkmall.offline.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmall.offline.common.util.ConfigurationUtil
import com.atguigu.sparkmall.offline.mock.util.{RandomDate, RandomNumUtil, RandomOptions}
